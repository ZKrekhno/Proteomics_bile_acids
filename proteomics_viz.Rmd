...
pwalk(list(same_dim_dots [small_index], same_dim_dots_labs_list [small_index], names(same_dim_dots) [small_index]), 
...
inter_index <- c(-3,-4)
#pdf(here::here("final results/enrichment results medium cat number.pdf"), width = 8, height = 6.66)
...
#pdf(here::here("final results/enrichment results large cat number.pdf"), width = 10, height = 9.5)
